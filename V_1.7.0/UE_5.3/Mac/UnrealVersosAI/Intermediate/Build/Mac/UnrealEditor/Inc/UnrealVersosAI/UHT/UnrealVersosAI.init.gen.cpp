...
void EmptyLinkFunctionForGeneratedCodeUnrealVersosAI_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_UnrealVersosAI()
	{
		if (!Z_Registration_Info_UPackage__Script_UnrealVersosAI.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_UnrealVersosAI_WebContent__DelegateSignature,
			};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_UnrealVersosAI(Z_Construct_UPackage__Script_UnrealVersosAI, TEXT("/Script/UnrealVersosAI"), Z_Registration_Info_UPackage__Script_UnrealVersosAI, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0xE32D9961, 0xE6A5D009));
