...
void FOnFileDownloadComplete_DelegateWrapper(const FMulticastScriptDelegate& OnFileDownloadComplete, bool bWasSuccessful)
{
	...
	DEFINE_FUNCTION(AUVersosBlueprintLibrary::execSliceArray)
	{
		P_GET_TARRAY_REF(FText,Z_Param_Out_InputArray);
		P_GET_PROPERTY(FIntProperty,Z_Param_Index);
		P_GET_PROPERTY(FIntProperty,Z_Param_Length);
		P_FINISH;
		P_NATIVE_BEGIN;
		*(TArray<FText>*)Z_Param__Result=AUVersosBlueprintLibrary::SliceArray(Z_Param_Out_InputArray,Z_Param_Index,Z_Param_Length);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(AUVersosBlueprintLibrary::execStringArrayToTextArray)
	{
		P_GET_TARRAY_REF(FString,Z_Param_Out_StringArray);
		P_FINISH;
		P_NATIVE_BEGIN;
		*(TArray<FText>*)Z_Param__Result=AUVersosBlueprintLibrary::StringArrayToTextArray(Z_Param_Out_StringArray);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(AUVersosBlueprintLibrary::execCosineSimilarity)
	{
		P_GET_TARRAY_REF(double,Z_Param_Out_VectorA);
		P_GET_TARRAY_REF(double,Z_Param_Out_VectorB);
		P_FINISH;
		P_NATIVE_BEGIN;
		*(double*)Z_Param__Result=AUVersosBlueprintLibrary::CosineSimilarity(Z_Param_Out_VectorA,Z_Param_Out_VectorB);
		P_NATIVE_END;
	}
	...
	DEFINE_FUNCTION(AUVersosBlueprintLibrary::execStartWebServer)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->StartWebServer();
		P_NATIVE_END;
	}
	...
	DEFINE_FUNCTION(AUVersosBlueprintLibrary::execCleanUpBullets)
	{
		...
		P_GET_PROPERTY(FIntProperty,Z_Param_PaddingLength);
		P_FINISH;
		P_NATIVE_BEGIN;
		*(TArray<FString>*)Z_Param__Result=AUVersosBlueprintLibrary::CleanUpBullets(Z_Param_JsonString,Z_Param_PaddingLength);
		P_NATIVE_END;
	}
	...
	void AUVersosBlueprintLibrary::StaticRegisterNativesAUVersosBlueprintLibrary()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "CosineSimilarity", &AUVersosBlueprintLibrary::execCosineSimilarity },
			...
			{ "SliceArray", &AUVersosBlueprintLibrary::execSliceArray },
			{ "SplitImageIntoQuadrants", &AUVersosBlueprintLibrary::execSplitImageIntoQuadrants },
			{ "StartWebServer", &AUVersosBlueprintLibrary::execStartWebServer },
			{ "StringArrayToTextArray", &AUVersosBlueprintLibrary::execStringArrayToTextArray },
		};
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_PaddingLength_MetaData[];
#endif
		static const UECodeGen_Private::FIntPropertyParams NewProp_PaddingLength;
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AUVersosBlueprintLibrary_CleanUpBullets_Statics::NewProp_PaddingLength_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_AUVersosBlueprintLibrary_CleanUpBullets_Statics::NewProp_PaddingLength = { "PaddingLength", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVersosBlueprintLibrary_eventCleanUpBullets_Parms, PaddingLength), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AUVersosBlueprintLibrary_CleanUpBullets_Statics::NewProp_PaddingLength_MetaData), Z_Construct_UFunction_AUVersosBlueprintLibrary_CleanUpBullets_Statics::NewProp_PaddingLength_MetaData) };
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AUVersosBlueprintLibrary_CleanUpBullets_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AUVersosBlueprintLibrary_CleanUpBullets_Statics::NewProp_PaddingLength,
	...
	struct Z_Construct_UFunction_AUVersosBlueprintLibrary_CosineSimilarity_Statics
	{
		struct UVersosBlueprintLibrary_eventCosineSimilarity_Parms
		{
			TArray<double> VectorA;
			TArray<double> VectorB;
			double ReturnValue;
		};
		static const UECodeGen_Private::FDoublePropertyParams NewProp_VectorA_Inner;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_VectorA_MetaData[];
#endif
		static const UECodeGen_Private::FArrayPropertyParams NewProp_VectorA;
		static const UECodeGen_Private::FDoublePropertyParams NewProp_VectorB_Inner;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_VectorB_MetaData[];
#endif
		static const UECodeGen_Private::FArrayPropertyParams NewProp_VectorB;
	...
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UFunction_AUVersosBlueprintLibrary_CosineSimilarity_Statics::NewProp_VectorA_Inner = { "VectorA", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AUVersosBlueprintLibrary_CosineSimilarity_Statics::NewProp_VectorA_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_AUVersosBlueprintLibrary_CosineSimilarity_Statics::NewProp_VectorA = { "VectorA", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVersosBlueprintLibrary_eventCosineSimilarity_Parms, VectorA), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AUVersosBlueprintLibrary_CosineSimilarity_Statics::NewProp_VectorA_MetaData), Z_Construct_UFunction_AUVersosBlueprintLibrary_CosineSimilarity_Statics::NewProp_VectorA_MetaData) };
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UFunction_AUVersosBlueprintLibrary_CosineSimilarity_Statics::NewProp_VectorB_Inner = { "VectorB", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AUVersosBlueprintLibrary_CosineSimilarity_Statics::NewProp_VectorB_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_AUVersosBlueprintLibrary_CosineSimilarity_Statics::NewProp_VectorB = { "VectorB", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVersosBlueprintLibrary_eventCosineSimilarity_Parms, VectorB), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AUVersosBlueprintLibrary_CosineSimilarity_Statics::NewProp_VectorB_MetaData), Z_Construct_UFunction_AUVersosBlueprintLibrary_CosineSimilarity_Statics::NewProp_VectorB_MetaData) };
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UFunction_AUVersosBlueprintLibrary_CosineSimilarity_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVersosBlueprintLibrary_eventCosineSimilarity_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AUVersosBlueprintLibrary_CosineSimilarity_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AUVersosBlueprintLibrary_CosineSimilarity_Statics::NewProp_VectorA_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AUVersosBlueprintLibrary_CosineSimilarity_Statics::NewProp_VectorA,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AUVersosBlueprintLibrary_CosineSimilarity_Statics::NewProp_VectorB_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AUVersosBlueprintLibrary_CosineSimilarity_Statics::NewProp_VectorB,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AUVersosBlueprintLibrary_CosineSimilarity_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AUVersosBlueprintLibrary_CosineSimilarity_Statics::Function_MetaDataParams[] = {
		{ "Category", "Versos|Utils" },
		{ "ModuleRelativePath", "Public/UnrealVersosAI.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AUVersosBlueprintLibrary_CosineSimilarity_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AUVersosBlueprintLibrary, nullptr, "CosineSimilarity", nullptr, nullptr, Z_Construct_UFunction_AUVersosBlueprintLibrary_CosineSimilarity_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AUVersosBlueprintLibrary_CosineSimilarity_Statics::PropPointers), sizeof(Z_Construct_UFunction_AUVersosBlueprintLibrary_CosineSimilarity_Statics::UVersosBlueprintLibrary_eventCosineSimilarity_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04422401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AUVersosBlueprintLibrary_CosineSimilarity_Statics::Function_MetaDataParams), Z_Construct_UFunction_AUVersosBlueprintLibrary_CosineSimilarity_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AUVersosBlueprintLibrary_CosineSimilarity_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_AUVersosBlueprintLibrary_CosineSimilarity_Statics::UVersosBlueprintLibrary_eventCosineSimilarity_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_AUVersosBlueprintLibrary_CosineSimilarity()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AUVersosBlueprintLibrary_CosineSimilarity_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_AUVersosBlueprintLibrary_SliceArray_Statics
	{
		struct UVersosBlueprintLibrary_eventSliceArray_Parms
		{
			TArray<FText> InputArray;
			int32 Index;
			int32 Length;
			TArray<FText> ReturnValue;
		};
		static const UECodeGen_Private::FTextPropertyParams NewProp_InputArray_Inner;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_InputArray_MetaData[];
#endif
		static const UECodeGen_Private::FArrayPropertyParams NewProp_InputArray;
	...
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UFunction_AUVersosBlueprintLibrary_SliceArray_Statics::NewProp_InputArray_Inner = { "InputArray", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AUVersosBlueprintLibrary_SliceArray_Statics::NewProp_InputArray_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_AUVersosBlueprintLibrary_SliceArray_Statics::NewProp_InputArray = { "InputArray", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVersosBlueprintLibrary_eventSliceArray_Parms, InputArray), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AUVersosBlueprintLibrary_SliceArray_Statics::NewProp_InputArray_MetaData), Z_Construct_UFunction_AUVersosBlueprintLibrary_SliceArray_Statics::NewProp_InputArray_MetaData) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_AUVersosBlueprintLibrary_SliceArray_Statics::NewProp_Index = { "Index", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVersosBlueprintLibrary_eventSliceArray_Parms, Index), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_AUVersosBlueprintLibrary_SliceArray_Statics::NewProp_Length = { "Length", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVersosBlueprintLibrary_eventSliceArray_Parms, Length), METADATA_PARAMS(0, nullptr) };
	...
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_AUVersosBlueprintLibrary_SliceArray_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVersosBlueprintLibrary_eventSliceArray_Parms, ReturnValue), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AUVersosBlueprintLibrary_SliceArray_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AUVersosBlueprintLibrary_SliceArray_Statics::NewProp_InputArray_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AUVersosBlueprintLibrary_SliceArray_Statics::NewProp_InputArray,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AUVersosBlueprintLibrary_SliceArray_Statics::NewProp_Index,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AUVersosBlueprintLibrary_SliceArray_Statics::NewProp_Length,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AUVersosBlueprintLibrary_SliceArray_Statics::NewProp_ReturnValue_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AUVersosBlueprintLibrary_SliceArray_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AUVersosBlueprintLibrary_SliceArray_Statics::Function_MetaDataParams[] = {
		{ "Category", "Versos|Utils" },
		{ "ModuleRelativePath", "Public/UnrealVersosAI.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AUVersosBlueprintLibrary_SliceArray_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AUVersosBlueprintLibrary, nullptr, "SliceArray", nullptr, nullptr, Z_Construct_UFunction_AUVersosBlueprintLibrary_SliceArray_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AUVersosBlueprintLibrary_SliceArray_Statics::PropPointers), sizeof(Z_Construct_UFunction_AUVersosBlueprintLibrary_SliceArray_Statics::UVersosBlueprintLibrary_eventSliceArray_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04422401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AUVersosBlueprintLibrary_SliceArray_Statics::Function_MetaDataParams), Z_Construct_UFunction_AUVersosBlueprintLibrary_SliceArray_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AUVersosBlueprintLibrary_SliceArray_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_AUVersosBlueprintLibrary_SliceArray_Statics::UVersosBlueprintLibrary_eventSliceArray_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_AUVersosBlueprintLibrary_SliceArray()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AUVersosBlueprintLibrary_SliceArray_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_AUVersosBlueprintLibrary_StartWebServer_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AUVersosBlueprintLibrary_StartWebServer_Statics::Function_MetaDataParams[] = {
		{ "Category", "Versos|HTTP" },
		{ "ModuleRelativePath", "Public/UnrealVersosAI.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AUVersosBlueprintLibrary_StartWebServer_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AUVersosBlueprintLibrary, nullptr, "StartWebServer", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AUVersosBlueprintLibrary_StartWebServer_Statics::Function_MetaDataParams), Z_Construct_UFunction_AUVersosBlueprintLibrary_StartWebServer_Statics::Function_MetaDataParams) };
	UFunction* Z_Construct_UFunction_AUVersosBlueprintLibrary_StartWebServer()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AUVersosBlueprintLibrary_StartWebServer_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AUVersosBlueprintLibrary_StringArrayToTextArray_Statics
	{
		struct UVersosBlueprintLibrary_eventStringArrayToTextArray_Parms
		{
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_AUVersosBlueprintLibrary_StringArrayToTextArray_Statics::NewProp_StringArray_Inner = { "StringArray", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AUVersosBlueprintLibrary_StringArrayToTextArray_Statics::NewProp_StringArray_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_AUVersosBlueprintLibrary_StringArrayToTextArray_Statics::NewProp_StringArray = { "StringArray", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVersosBlueprintLibrary_eventStringArrayToTextArray_Parms, StringArray), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AUVersosBlueprintLibrary_StringArrayToTextArray_Statics::NewProp_StringArray_MetaData), Z_Construct_UFunction_AUVersosBlueprintLibrary_StringArrayToTextArray_Statics::NewProp_StringArray_MetaData) };
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UFunction_AUVersosBlueprintLibrary_StringArrayToTextArray_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_AUVersosBlueprintLibrary_StringArrayToTextArray_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVersosBlueprintLibrary_eventStringArrayToTextArray_Parms, ReturnValue), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AUVersosBlueprintLibrary_StringArrayToTextArray_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AUVersosBlueprintLibrary_StringArrayToTextArray_Statics::NewProp_StringArray_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AUVersosBlueprintLibrary_StringArrayToTextArray_Statics::NewProp_StringArray,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AUVersosBlueprintLibrary_StringArrayToTextArray_Statics::NewProp_ReturnValue_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AUVersosBlueprintLibrary_StringArrayToTextArray_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AUVersosBlueprintLibrary_StringArrayToTextArray_Statics::Function_MetaDataParams[] = {
		{ "Category", "Versos|Utils" },
		{ "ModuleRelativePath", "Public/UnrealVersosAI.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AUVersosBlueprintLibrary_StringArrayToTextArray_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AUVersosBlueprintLibrary, nullptr, "StringArrayToTextArray", nullptr, nullptr, Z_Construct_UFunction_AUVersosBlueprintLibrary_StringArrayToTextArray_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AUVersosBlueprintLibrary_StringArrayToTextArray_Statics::PropPointers), sizeof(Z_Construct_UFunction_AUVersosBlueprintLibrary_StringArrayToTextArray_Statics::UVersosBlueprintLibrary_eventStringArrayToTextArray_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04422401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AUVersosBlueprintLibrary_StringArrayToTextArray_Statics::Function_MetaDataParams), Z_Construct_UFunction_AUVersosBlueprintLibrary_StringArrayToTextArray_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AUVersosBlueprintLibrary_StringArrayToTextArray_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_AUVersosBlueprintLibrary_StringArrayToTextArray_Statics::UVersosBlueprintLibrary_eventStringArrayToTextArray_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_AUVersosBlueprintLibrary_StringArrayToTextArray()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AUVersosBlueprintLibrary_StringArrayToTextArray_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_WebServerInstance_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp_WebServerInstance;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AUVersosBlueprintLibrary_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_AUVersosBlueprintLibrary_CleanUpBullets, "CleanUpBullets" }, // 3109215262
		{ &Z_Construct_UFunction_AUVersosBlueprintLibrary_CosineSimilarity, "CosineSimilarity" }, // 3647042937
		...
		{ &Z_Construct_UFunction_AUVersosBlueprintLibrary_SliceArray, "SliceArray" }, // 2591509951
		{ &Z_Construct_UFunction_AUVersosBlueprintLibrary_SplitImageIntoQuadrants, "SplitImageIntoQuadrants" }, // 2889769051
		{ &Z_Construct_UFunction_AUVersosBlueprintLibrary_StartWebServer, "StartWebServer" }, // 2636689984
		{ &Z_Construct_UFunction_AUVersosBlueprintLibrary_StringArrayToTextArray, "StringArrayToTextArray" }, // 2832552023
	};
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AUVersosBlueprintLibrary_Statics::NewProp_WebServerInstance_MetaData[] = {
		{ "ModuleRelativePath", "Public/UnrealVersosAI.h" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AUVersosBlueprintLibrary_Statics::NewProp_WebServerInstance = { "WebServerInstance", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AUVersosBlueprintLibrary, WebServerInstance), Z_Construct_UClass_UWebServer_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AUVersosBlueprintLibrary_Statics::NewProp_WebServerInstance_MetaData), Z_Construct_UClass_AUVersosBlueprintLibrary_Statics::NewProp_WebServerInstance_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AUVersosBlueprintLibrary_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AUVersosBlueprintLibrary_Statics::NewProp_WebServerInstance,
	...
	struct Z_CompiledInDeferFile_FID_cgm_Documents_VersosPlugin17_UnrealVersosAI_HostProject_Plugins_UnrealVersosAI_Source_UnrealVersosAI_Public_UnrealVersosAI_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_cgm_Documents_VersosPlugin17_UnrealVersosAI_HostProject_Plugins_UnrealVersosAI_Source_UnrealVersosAI_Public_UnrealVersosAI_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_cgm_Documents_VersosPlugin17_UnrealVersosAI_HostProject_Plugins_UnrealVersosAI_Source_UnrealVersosAI_Public_UnrealVersosAI_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AUVersosBlueprintLibrary, AUVersosBlueprintLibrary::StaticClass, TEXT("AUVersosBlueprintLibrary"), &Z_Registration_Info_UClass_AUVersosBlueprintLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AUVersosBlueprintLibrary), 1368052932U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_cgm_Documents_VersosPlugin17_UnrealVersosAI_HostProject_Plugins_UnrealVersosAI_Source_UnrealVersosAI_Public_UnrealVersosAI_h_2421205909(TEXT("/Script/UnrealVersosAI"),
		Z_CompiledInDeferFile_FID_cgm_Documents_VersosPlugin17_UnrealVersosAI_HostProject_Plugins_UnrealVersosAI_Source_UnrealVersosAI_Public_UnrealVersosAI_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_cgm_Documents_VersosPlugin17_UnrealVersosAI_HostProject_Plugins_UnrealVersosAI_Source_UnrealVersosAI_Public_UnrealVersosAI_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_cgm_Documents_VersosPlugin17_UnrealVersosAI_HostProject_Plugins_UnrealVersosAI_Source_UnrealVersosAI_Public_UnrealVersosAI_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_cgm_Documents_VersosPlugin17_UnrealVersosAI_HostProject_Plugins_UnrealVersosAI_Source_UnrealVersosAI_Public_UnrealVersosAI_h_Statics::ScriptStructInfo),
		nullptr, 0);
