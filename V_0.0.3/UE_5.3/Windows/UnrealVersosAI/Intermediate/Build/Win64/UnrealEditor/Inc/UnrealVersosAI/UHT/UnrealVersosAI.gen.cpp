...
void FOnImagePostComplete_DelegateWrapper(const FMulticastScriptDelegate& OnImagePostComplete, const FString& ResponseBody, bool bWasSuccessful)
{
	...
	DEFINE_FUNCTION(UVersosBlueprintLibrary::execPostImageToAPI)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->PostImageToAPI(Z_Param_ImagePath,Z_Param_ApiKey,Z_Param_ProjectId,Z_Param_CustomerId);
		P_NATIVE_END;
	}
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UVersosBlueprintLibrary_GetInstance_Statics::Function_MetaDataParams[] = {
		...
		{ "Comment", "// Static method to access the class instance\n" },
		{ "ModuleRelativePath", "Public/UnrealVersosAI.h" },
		{ "ToolTip", "Static method to access the class instance" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UVersosBlueprintLibrary_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UVersosBlueprintLibrary_GetInstance, "GetInstance" }, // 1498494515
		{ &Z_Construct_UFunction_UVersosBlueprintLibrary_OpenFileDialog, "OpenFileDialog" }, // 2926432472
		{ &Z_Construct_UFunction_UVersosBlueprintLibrary_PostImageToAPI, "PostImageToAPI" }, // 3855187389
	};
	...
	struct Z_CompiledInDeferFile_FID_Users_cezar_Documents_plugin_mar_08_UnrealVersosAI_HostProject_Plugins_UnrealVersosAI_Source_UnrealVersosAI_Public_UnrealVersosAI_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_cezar_Documents_plugin_mar_08_UnrealVersosAI_HostProject_Plugins_UnrealVersosAI_Source_UnrealVersosAI_Public_UnrealVersosAI_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_cezar_Documents_plugin_mar_08_UnrealVersosAI_HostProject_Plugins_UnrealVersosAI_Source_UnrealVersosAI_Public_UnrealVersosAI_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVersosBlueprintLibrary, UVersosBlueprintLibrary::StaticClass, TEXT("UVersosBlueprintLibrary"), &Z_Registration_Info_UClass_UVersosBlueprintLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVersosBlueprintLibrary), 465184339U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_cezar_Documents_plugin_mar_08_UnrealVersosAI_HostProject_Plugins_UnrealVersosAI_Source_UnrealVersosAI_Public_UnrealVersosAI_h_1959413033(TEXT("/Script/UnrealVersosAI"),
		Z_CompiledInDeferFile_FID_Users_cezar_Documents_plugin_mar_08_UnrealVersosAI_HostProject_Plugins_UnrealVersosAI_Source_UnrealVersosAI_Public_UnrealVersosAI_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_cezar_Documents_plugin_mar_08_UnrealVersosAI_HostProject_Plugins_UnrealVersosAI_Source_UnrealVersosAI_Public_UnrealVersosAI_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Users_cezar_Documents_plugin_mar_08_UnrealVersosAI_HostProject_Plugins_UnrealVersosAI_Source_UnrealVersosAI_Public_UnrealVersosAI_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_cezar_Documents_plugin_mar_08_UnrealVersosAI_HostProject_Plugins_UnrealVersosAI_Source_UnrealVersosAI_Public_UnrealVersosAI_h_Statics::ScriptStructInfo),
		nullptr, 0);
